...
class State_Machine:
    ...
    def __init__(self, game: Game, states: dict[State, type[Base_State]] | None = None) -> None:
        self.game: Game = game
        self.empty_state: type[Base_State] = type("Empty_State", (Base_State,), {'enter': lambda self : None, 'exit': lambda self : None, 'update': lambda self : None, 'draw': lambda self : None})
